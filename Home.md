...
| [Küsimused ja vastused — A2 eksamiks](Kysimused-A2-eksamiks.md) | 125 speaking-test questions with model answers, grouped by exam topic, from both coursebooks | ✅ Complete |
...
| — | [Kordamine 1–5 (Revision)](Nagu-Eesti-05b-Kordamine-1-5.md) | 34–45 | ✅ Done |
...
- Pick a book above and open any chapter, or use the **collapsible book menus** in the sidebar.
- Work through a chapter top to bottom — the order matches the printed book.
- Try every exercise *before* opening the **Answers** drop-down.
- Open the **🇬🇧 Translation** drop-downs for English; use the **word list** at the end of each chapter for revision.
